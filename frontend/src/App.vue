...
:root {
    ...
    --primaryColorMainLight: #2c354a;
    --primaryColorMainDark: #24407d;
    --primaryColorDark: #0e1930;
    --secondaryColorLight: #6effb9;
    --secondaryColorMainLight: #00bf96;
    --secondaryColorMainDark: #11804a;
    --secondaryColorDark: #37805c;
    --grey: #282828;
    --fontBlack: black;
    --fontWhite: white;
    --fontLight: #eae1e1;
...
[data-theme="dark"] {
    ...
    --primaryColorMainLight: #eae1e1;
    --primaryColorMainDark: #cccccc;
